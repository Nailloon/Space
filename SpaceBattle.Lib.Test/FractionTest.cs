...
namespace Tests.TestFraction
{
    public class TestFraction
    {
        ...
        public void TestSumma()
        {
            ...
            Assert.True(Fraction.AreEquals(new Fraction(1, 1), a + b));
        ...
        public void TestSubstraction()
        {
            ...
            Assert.True(Fraction.AreEquals(new Fraction(-2, 3), a - b));
        ...
        public void TestMultInt()
        {
            ...
            Assert.False(Fraction.AreEquals(new Fraction(5, -2), -5 * a));
        }
        ...
        public void TestForm()
        {
            ...
            Assert.True(Fraction.AreEquals(new Fraction(1, 2), Fraction.Transformation(a)));
            Assert.True(Fraction.AreEquals(new Fraction(3, 4), Fraction.Transformation(b)));
            Assert.False(Fraction.AreEquals(new Fraction(2, 4), Fraction.Transformation(a)));
        }
    }
}
